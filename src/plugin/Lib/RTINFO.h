...
inline void vftable_t::Print() { dprintf("  pCompleteObjectLocator: %p\n", pCompleteObjectLocator); }
...
inline void PMD::Print() { dprintf("    mdisp: %d  pdisp: %d  vdisp: %d\n", mdisp, pdisp, vdisp); }
...
struct RTTIClassHierarchyDescriptor
{
    ...
    DWORD pBaseClassArray; // Index 0 of this array is always 'this' class first   in x64 this is an offset from the
                           // module base to the array
...
struct RTTICompleteObjectLocator
{
    ...
    DWORD pTypeDescriptor; // TypeDescriptor of the complete class;   in x64 this field is an offset from the module
                           // base address
    DWORD pClassHierarchyDescriptor; // describes inheritance hierarchy;		  in x64 this field is an offset from
